  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: "Controllers", count: counts.controller, color: "var(--emerald-soft)", bg: "var(--emerald-dim)" },
      ...
      <div className="rounded-2xl border border-[rgba(16,185,129,0.25)] p-4 flex items-start gap-3"
        style={{ background: "var(--emerald-dim)" }}>
        <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: "var(--emerald-dim)" }}>
          <Users className="h-4 w-4" style={{ color: "var(--emerald-soft)" }} />
        </div>
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <a href="https://supabase.com/dashboard/project/_/auth/providers" target="_blank" rel="noopener noreferrer"
              className="underline underline-offset-2" style={{ color: "var(--emerald-soft)" }}>
